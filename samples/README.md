...
| [*dsa*](https://github.com/bellanov/python-samples/tree/main/samples/dsa) | Data Structures and Algorithms (DSA), including the Strategy Pattern. |
...
| [*rich*](https://github.com/bellanov/python-samples/tree/main/samples/rich) | Overview of the *Rich* library for terminal formatting in Python. |
...
| [*virtual_environments*](https://github.com/bellanov/python-samples/tree/main/samples/virtual_environments) | Overview of *Virtual Environments* and their usage. |
